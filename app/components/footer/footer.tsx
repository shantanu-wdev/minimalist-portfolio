...
export default function Footer() {
  return (
    <footer className="w-full bg-white/70 backdrop-blur-md border-t border-gray-200">
      <div className="footer-inner flex justify-center p-0">
        <div className="w-11/12 max-w-[2000px] py-10 flex flex-col md:flex-row justify-between items-center gap-6 text-gray-700">
            {/* Left: Branding */}
            ...
            <div className="flex gap-4 text-xl">
              ...
              <a href="https://leetcode.com/yourhandle" target="_blank" className="hover:text-gray-900 transition">
                <CustomLeetCodeIcon />
              </a>
            </div>
          </div>
