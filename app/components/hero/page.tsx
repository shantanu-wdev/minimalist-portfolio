    ...
    <section className="w-full h-full flex justify-center bg-white">
      <div className="hero-container w-11/12 flex flex-col gap-5 md:gap-16 items-center px-0 pt-24 md:pt-32 pb-8">
        ...
        <div className="hero-heading w-full">
          ...
          <h1 className="text-3xl lg:text-5xl xl:text-7xl font-bold leading-tight text-gray-900">
            { _interface.heroSection.title }
          </h1>
        </div>

        <div className="hero-text w-full flex flex-col lg:flex-row gap-5 lg:gap-0 text-center lg:text-left">
          <div className="w-full md:w-4/12 flex gap-4 justify-start items-start md:items-center">
          ...
          <p className="w-full lg:w-7/12 text-lg md:text-xl xl:text-2xl text-left text-gray-700">
